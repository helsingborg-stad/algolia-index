...
class IndexTest extends WP_UnitTestCase
{
    ...
    public function testThatShouldIndexIsEnabledByDefault()
    {
        ...
        // When
        $isIndexable = $this->invokeMethod($this->targetTestClass, 'shouldIndex', [$post]);
    ...
    public function testThatASmallRecordIsentTooLarge()
    {
        ...
        // When
        $recordTooLarge = $this->invokeMethod($this->targetTestClass, 'recordToLarge', [$post]);
    ...
    public function testThatAExerptIsShortened()
    {
        ...
        // When
        $truncatedExcerpt = $this->invokeMethod($this->targetTestClass, 'getTheExcerpt', [$post]);
